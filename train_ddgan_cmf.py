...
def sample_from_model(coefficients, generator, sobel, n_time, x_init, T, opt, hpf=None):
    x = x_init
    with torch.no_grad():
...
def train(rank, gpu, args):
    ...
    dataset = common_cmf.Dataset(args.data_dir, modality=args.modality, n_slices=args.num_channels)
    ...
    for epoch in range(init_epoch, args.num_epoch+1):
        ...
        if rank == 0:
            ...
            if epoch % args.save_ckpt_every == 0:
                ...
                torch.save(netG.state_dict(), os.path.join(exp_path, 'netG_last.pth'))
                if args.use_ema:
                    optimizerG.swap_parameters_with_ema(store_params_in_ema=True)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', default='cmf', help='name of dataset')
    parser.add_argument('--data_dir', default='/home/chenxu/datasets/cmf', help='name of dataset')
